...
public final class TablaDeSimbolos {
    ...
    // Table version --> A partir de aca la idea de una lista de metodos global
    ...
    /*
        TABLE VERSION --> Se ponen primero los metodos en conflicto
     */
